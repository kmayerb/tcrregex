...
from tcrregex.olga.utils import nt2aa, determine_seq_type
from tcrregex.paths import path_to_olga_default_models
...
class OlgaModel:
    ...
    def __repr__(self):
        return "tcrregex.pgen.OlgaModel set to recomb_type: '{}' and chain_folder: '{}'".format(self.recomb_type, self.chain_folder)
