...
def apply_pw_distance_metric_w_multiprocessing(sequences,
    ...
    by :py:func:`tcrregex.pairwise.function_factory` (when :py:attr:`metric` is
    ...
    In practice, this would be called from the :py:class:`tcrregex.repertoire.TCRrep`
    class.
    ...
    must be one of the following: 'nw','hamming','tcrregex_cdr3', 'tcrregex_cdr1', 'custom'."

    if metric not in ("nw", "hamming", "custom", 'tcrregex_cdr3', 'tcrregex_cdr1'):
...
def tcrregex_cdr3_metric(s1,s2, **kwargs):
    """
    ...
    Examples
    --------
    >>> tcrregex_cdr3_metric('CALDNVLYF','CAASEHLYGSSGNKLIF')
    132
    >>> tcrregex_cdr3_metric('CAASEHLYGSSGNKLIF','CAASEHLYGSSGNKLIF')
    0
...
def tcrregex_cdr1_metric(s1,s2, **kwargs):
    """
...
def function_factory(metric = "nw", **kwargs):
    ...
    if metric == "tcrregex_cdr3":
        def distance_wrapper(a, b):
            return(tcrregex_cdr3_metric(a, b, **kwargs))
    if metric in ["tcrregex_cdr1", "tcrregex_cdr2", "tcrregex_cdr2.5", "tcrregex_pmhc"]:
        def distance_wrapper(a, b):
            return(tcrregex_cdr1_metric(a, b, **kwargs))
    if metric == "hamming2":
        def distance_wrapper(a, b):
...
class SequencePair:
    ...
    YET VALIDATED COMPARED TO ORIGINAL tcrregex
