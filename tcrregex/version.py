...
description = "tcrregex2: a package for analyzing TCR repertoire datasets"
# Long description will go up on the pypi page
long_description = """
tcrregex2
========
tcrregex2 is a package for analyzing T-cell receptor repertoire datasets.
...
repository README.
.. _README: https://github.com/kmayerb/tcrregex2/blob/API2/README.md

License
=======
``tcrregex2`` is licensed under the terms of the MIT license. See the file
...
URL = "http://github.com/kmayerb/tcrregex2"
DOWNLOAD_URL = ""
LICENSE = "MIT"
...
VERSION = __version__
PACKAGE_DATA = {'tcrregex': ['datasets/test_human_pairseqs.tsv',
