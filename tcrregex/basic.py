...
import random
#from .blargs import Parser _ I DON"T WANT THIS DEPENDENCY
#from . import parse_tsv
from . import paths

############################################################################################
############################################################################################
## some shared tcrregex analysis pipeline parameters
...
pipeline_params= {
    ...
    ## The history is that with the original tcrregex we used nice round values of 25/50 for
    ## several distance thresholds. When we moved to the updated tcrregex, on average
