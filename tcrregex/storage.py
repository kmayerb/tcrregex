class StoreIO():
    ...
    Parent class for passing multiple objects between tcrregex2 functions.
...
class StoreIOMotif(StoreIO):
    ...
    See tcrregex.TCRMotif.find_cdr3()

    These attributes are added by tcrregex.subset.analyze_motif()
...
class StoreIOEntropy(StoreIO):
    ...
    from tcrregex.subset.analyze_matches_using_ngseqs()
