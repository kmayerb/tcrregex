...
def install_test_files():
    ...
    install_dropbox_file("mouse_pairseqs_v1_parsed_seqs_probs_mq20_clones.tsv",
                         "https://www.dropbox.com/s/l0z12f8lc752wfx/mouse_pairseqs_v1_parsed_seqs_probs_mq20_clones.tsv?dl=1",
                         "test_files")
    install_dropbox_file("M_F1_2019_alpha_tcrregex2.csv",
                        "https://www.dropbox.com/s/p0g6izun8qqw0m6/M_F1_2019_alpha_tcrregex2.csv?dl=1",
                        "test_files")
...
def install_dropbox_file(filename,
    ...
    -------
    curl_url_cmd : string
        the command for installing to tcrregex/db/alphabeta_db.tsv_files/*

    """
    assert isinstance(filename, str), "filename must be a string"
    assert isinstance(download_link, str), "download link must be a string"
    assert isinstance(install_dir, str), "install_dir must be a string"  # TODO: Consider in future nested directory case tcrregex/X/Y, you could use reduce os os.path.join()
